      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="mt-20 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            {["React 18", "TypeScript", "Tailwind CSS", "Vite", "Supabase", "WebRTC", "PWA", "Chart.js", "TensorFlow.js", "Web3"].map(tech => <Badge key={tech} className="px-4 py-2 bg-gradient-primary text-primary-foreground border-0 hover:scale-110 smooth cursor-default">
                {tech}
              </Badge>)}
          </div>
        </div>
