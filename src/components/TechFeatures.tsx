  ...
  return (
    <section className="py-20 bg-gradient-to-b from-muted/20 to-background relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-30">
        ...
        <div className="absolute top-32 right-20 w-24 h-24 bg-gradient-to-br from-secondary/20 to-transparent rounded-full blur-xl animate-float" style={{ animationDelay: '2s' }}></div>
        <div className="absolute bottom-20 left-1/3 w-40 h-40 bg-gradient-to-br from-accent/20 to-transparent rounded-full blur-xl animate-float" style={{ animationDelay: '4s' }}></div>
      </div>
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-6">
            <span className="text-foreground">Mind-Blowing</span>{" "}
            <span className="gradient-text">Tech Features</span>
          </h2>
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
            Experience the future of food delivery with our revolutionary platform built using 
            the latest technologies and innovative solutions that will impress any recruiter.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-4 gap-6">
          {features.map((feature, index) => (
            <Card
              key={feature.title}
              className="group relative overflow-hidden border-0 glass hover:shadow-elegant smooth hover:scale-105 animate-fade-in"
        ...
        <div className="mt-20 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            {[
              "React 18", "TypeScript", "Tailwind CSS", "Vite", "Supabase", 
              "WebRTC", "PWA", "Chart.js", "TensorFlow.js", "Web3"
            ].map((tech) => (
              <Badge
                key={tech}
                className="px-4 py-2 bg-gradient-primary text-primary-foreground border-0 hover:scale-110 smooth cursor-default"
              >
                {tech}
              </Badge>
            ))}
